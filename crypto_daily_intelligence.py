...
数据管线（20+数据源，BTC/ETH聚焦）：
  ...
  11. 大V观点：9个KOL/媒体的Substack/Medium/RSS（Arthur Hayes、吴说、Willy Woo、PlanB、刘教链、Odaily、PANews、The Block、Bankless），7天窗口
...
SOURCE_TIER = {
    ...
    # KOL大V — 个人分析师和华语头部媒体
    'Arthur Hayes': 'T1', 'Wu Blockchain': 'T1', 'Willy Woo': 'T1', 'PlanB': 'T1',
    'The Block': 'T1', 'Bankless': 'T1',
    '刘教链': 'T2', 'Odaily': 'T2', 'PANews': 'T2',
    # CryptoCompare子源默认T3
}
...
def collect_kol_opinions():
    ...
    KOL_FEEDS = [
        ...
        ('PlanB', 'https://medium.com/feed/@100trillionUSD', 'medium', 'S2F模型创始人，长期BTC价格预测'),
        ('刘教链', 'https://blockcoach.substack.com/feed', 'substack', '北航教授，BTC长期价值投资'),
        # 华语头部加密媒体 — 深度报道+快讯
        ...
        # 英文头部加密媒体深度文章（补充更多观点来源）
        ('The Block', 'https://www.theblock.co/rss.xml', 'rss', '加密行业顶级财经媒体，数据驱动型报道'),
        ('Bankless', 'https://feeds.banklesshq.com/rss', 'rss', 'DeFi/ETH生态深度分析，Web3思想领袖'),
    ]
...
def format_data_context(market, onchain, mining, funding, oi_ls, options, defi, macro, sentiment, news, kol_opinions=None):
    ...
    s += 'KOL背景：Arthur Hayes=前BitMEX CEO宏观分析 | Wu Blockchain=华语行业信息枢纽 | Willy Woo=BTC链上数据专家 | PlanB=S2F模型创始人 | 刘教链=北航教授BTC价值投资 | Odaily=华语头部媒体 | PANews=华语头部媒体 | The Block=英文顶级财经媒体 | Bankless=DeFi/ETH思想领袖\n\n'
    if kol_opinions:
...
def main():
    print(f'=== 加密货币投研日报 v2.2 (Mining-Focused, 6-Charts, KOL) ===')
