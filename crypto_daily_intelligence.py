...
## 篇幅要求（最高优先级，违反=报废重写）
- **总报告不少于8000字**。少于8000字的报告不合格
- 各章节最低字数：快照200字、核心矛盾800字、矿工经济学1500字、BTC深度1000字、ETH分析500字、宏观800字、新闻每条250字、大V观点1000字、DeFi 300字、风险矩阵800字
- 宁可写得过于详细也不要写得过于简略——董事长是在iPad上阅读，有的是时间
- 如果某个章节字数不够，说明你还可以加入更多历史类比、更多因果推演、更多量化估算
...
**第三部分：矿工经济学**（⚠️ 最重要章节，不少于1500字，矿场董事长核心关注）
...
**第五部分：ETH分析**（不少于500字，作为第二大持仓需认真对待）
...
**第七部分：行业动态深度分析**（⚠️ 最重要的深度章节，每条新闻不少于250字）
...
**第八部分：大V观点与市场共识**（⚠️ 不少于1000字，必须逐个KOL深度分析）
